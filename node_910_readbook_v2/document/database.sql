...
무결성을 보장하기 위하여
    ...
    여러 민감한 데이터의 손상, 변화(INSERT, UPDATE, DELETE)를 최소화하여야한다.
*/
-- callor 사용자에게 bookDB2 테이블에 대하여 권한을 부여하기
-- TABLE 생성, CRUD 를 수행할 수 있다.

GRANT ALL PRIVILEGES ON bookDB2.* TO 'hykim6856'@'localhost'
GRANT ALL PRIVILEGES ON *.* TO 'hykim6856'@'localhost'
