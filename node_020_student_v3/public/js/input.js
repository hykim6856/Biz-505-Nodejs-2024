document.addEventListener("DOMContentLoaded", () => {
  ...
  st_num?.addEventListener("blur", async (event) => {
    ...
    if (!value) {
      error_divs[ST_INDEX.ST_NUM].innerHTML = "학번을 입력해주세요";
      // alert("학번은 반드시 입력하세요");
      target.select();
      return false;
    } else {
...
// if (!value) {
//   error_divs[ST_INDEX.ST_NAME].innerHTML = "이름을 입력해주세요";
//   target.select();
//   return false;
// } else {
// }
